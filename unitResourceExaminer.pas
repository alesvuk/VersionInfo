...
protected
  ...
  function GetDisplayName: AnsiString; virtual; abstract;
public
...
public
  constructor Create (AOwner : TObject; ABaseAddr : PAnsiChar; AImageImportDirectory : PImageImportDirectory);
  ...
  property BaseAddress : PAnsiChar read fBaseAddr;
end;
...
protected
  function GetDisplayName : AnsiString; override;
public
  constructor Create (AOwner : TResExamType; const AName : AnsiString);
...
protected
  function GetDisplayName : AnsiString; override;
public
  constructor Create (AOwner : TResourceExaminer; const AName : AnsiString);
  property Name : AnsiString read fName;
...
public
  constructor Create (AOwner : TObject; BaseAddr : PAnsiChar);
...
function PixelFormatToString (pf : TPixelFormat) : AnsiString;
...
(*----------------------------------------------------------------------*
 | function PixelFormatToString () : AnsiString                             |
 |                                                                      |
 | Return AnsiString representation of a TPixelFormat                       |
 |                                                                      |
 | Parameters:                                                          |
...
(*----------------------------------------------------------------------*
 ...
 |                                                                      |
 | Parameters:                                                          |
 |   const tp : AnsiString          The resource type                       |
 *----------------------------------------------------------------------*)
function GetTypeName (const tp : AnsiString) : AnsiString;
var
  i : Integer;
begin
 ...
 *----------------------------------------------------------------------*)
function GetLangName (language : Integer) : AnsiString;
begin
  if language = 0 then
...
(*----------------------------------------------------------------------*
 ...
 |                                                                      |
 | Parameters:                                                          |
 |   const FileName: AnsiString     The name of the PE file                 |
 *----------------------------------------------------------------------*)
constructor TResourceExaminer.Create(const FileName: AnsiString);
begin
...
function TResExamLang.GetDisplayName: AnsiString;
begin
...
constructor TResExamName.Create(AOwner: TResExamType; const AName: AnsiString);
begin
  inherited Create;
  fOwner := AOwner;
  fName := AName;
...
function TResExamName.GetDisplayName: AnsiString;
begin
  result := Name;
end;
...
function TResExamType.GetDisplayName: AnsiString;
begin
...
function TResExamIconCursor.GetDisplayName: AnsiString;
var
...
constructor TResExamSection.Create(const AName: AnsiString);
begin
  inherited Create;
  fName := AName;
end;

function TResExamSection.GetDisplayName: AnsiString;
begin
  result := Name
end;
...
constructor TResExamImport.Create(AOwner: TObject;ABaseAddr : PAnsiChar;
...
function TResExamImport.GetDisplayName: AnsiString;
begin
  result := ImportName
end;
...
begin
  result := PAnsiChar (fBaseAddr) + fImageImportDirectory^.Name
end;

{ TExportResExamSection }

constructor TExportResExamSection.Create(AOwner: TObject; BaseAddr: PAnsiChar);
begin
