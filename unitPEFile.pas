...
TResourceDirectoryTable = packed record
  ...
  cNameEntries : WORD;     // Number of directory entries, immediately following the table, that use AnsiStrings to identify Type, Name, or Language (depending on the level of the table).
